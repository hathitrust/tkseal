...
class TestSealKubesealMethod:
    ...
    def test_kubeseal_calls_wrapper_with_correct_params(
        self, mocker, simple_mock_secret_state
    ):
    ...
    def test_kubeseal_returns_sealed_value(self, mocker, simple_mock_secret_state):
...
class TestSealRun:
    ...
    def test_run_reads_plain_secrets(
        ...
        simple_mock_secret_state.plain_secrets.assert_called_once()

    def test_run_creates_sealed_secret_structure(
        self, mocker, simple_mock_secret_state, sample_plain_secrets, tmp_path
    ):
    ...
    def test_run_handles_multiple_secrets(
        self, mocker, simple_mock_secret_state, sample_plain_secrets_multiple, tmp_path
    ):
