...
class TestPullCommand:
    ...
    def test_pull_command_with_confirmation_accepted(self, mocker, temp_tanka_env, mock_secret_state):
    ...
    def test_pull_command_with_confirmation_declined(self, mocker, temp_tanka_env, mock_secret_state):
    ...
    def test_pull_command_no_differences(self, mocker, temp_tanka_env, mock_secret_state):
